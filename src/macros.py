...
def MACRO_1():
    ...
    try_async_macro(cs7350a3.parse_rubric)
    try_async_macro(cs7350a3.parse_student_assignments)


def MACRO_2():
    rich.print('[bold on #004477]      MACRO_2      [/]')
    try_async_macro(cs7350a3.make_entries)


def MACRO_3():
    rich.print('[bold on #004477]      MACRO_3      [/]')
    try_async_macro(cs7350a3.grade_with_llm)
